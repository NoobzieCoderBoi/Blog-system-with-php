...
<body>
    ...
    <div class="terms">
        <div class="tnc">
                    ...
                    <p>These terms of service outline the rules and regulations for the use of Online Tutorials’s Website.</p>
                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to use<br>
                        Online Tutorials’s website if you do not accept all of the terms of service stated on this page.</p>
                    <p>The following terminology applies to these Terms of Service, Privacy Statement and Disclaimer Notice and<br>
                        ...
                        of . Any use of the above terminology or other words in the singular, plural,<br>
                        capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
                    <h2>Cookies</h2>
                    <p>We employ the use of cookies. By using Online Tutorials’s website you consent to the use of cookies<br>
                        in accordance with Online Tutorials’s privacy policy.</p>
                    ...
                    <h2>License</h2>
                    <p>Unless otherwise stated, Online Tutorials and/or it’s licensors own the intellectual property rights for<br>
                        all material on Online Tutorials. All intellectual property rights are reserved. You may view and/or print<br>
                        pages from onlinetutorialsweb.com/ for your own personal use subject to restrictions set in these terms of service.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from onlinetutorialsweb.com/</li>
                        <li>Sell, rent or sub-license material from onlinetutorialsweb.com/</li>
                        <li>Reproduce, duplicate or copy material from onlinetutorialsweb.com/</li>
                    </ol>
                    <p>Redistribute content from Online Tutorials (unless content is specifically made for redistribution).</p>
                    <h2>User Comments</h2>
                    <ol>
                        <li>This Agreement shall begin on the date hereof.</li>
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,<br>
                            material and data (‘Comments’) in areas of the website. Online Tutorials does not screen, edit, publish<br>
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or<br>
                            opinions of Online Tutorials, its agents or affiliates. Comments reflect the view and opinion of the<br>
                            person who posts such view or opinion. To the extent permitted by applicable laws Online Tutorials shall<br>
                            ...
                            website.</li>
                        <li>Online Tutorials reserves the right to monitor all Comments and to remove any Comments which it considers<br>
                        ...
                        <li>You hereby grant to <strong>Online Tutorials</strong> a non-exclusive royalty-free license to use, reproduce,<br>
                    ...
                    <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect<br>
                        ...
                        the visibility associated with the hyperlink outweighs the absence of Online Tutorials; and (d) where the<br>
                    ...
                    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,<br>
                        you must notify us by sending an e-mail to <a title="send an email to irshad006macet@gmail.com" href="mailto:irshad006macet@gmail.com">irshad006macet@gmail.com</a>.<br>
                    ...
                    <p>No use of Online Tutorials’s logo or other artwork will be allowed for linking absent a trademark license<br>
                        agreement.</p>
                    <h2>Iframes</h2>
                    ...
                    <p>This Terms of service page was created at <a style="color: inherit; text-decoration: none; cursor: text;" href="https://privacyterms.io/">privacyterms.io</a>. If you have<br>
