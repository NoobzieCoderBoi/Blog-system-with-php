    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" style="cursor: pointer;" href="categories">Categories<span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
            ...
            <tbody>
                <tr>
                    ...
                    ?>
                            ...
                            <td><a href="delete-category?cid=<?php echo $row['cid'] ?>" class="btn btn-danger">Delete</a></td>
                </tr>
        <?php
                        }
                    } else {
